...
export default function ServiceManagement(props: IServiceManagementProps) {
  ...
  return (
    <div className="relative">
      <div className="p-2 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-4 dark:bg-gray-800">
      ...
      <Model isOpen={isModalOpen} onClose={closeModal}>
        <div className="w-full h-full mt-2 overflow-y-scroll bg-white dark:bg-gray-700 flex flex-col items-center justify-center">
          <form className="w-full h-full flex flex-col p-2 gap-5">
            <div>
